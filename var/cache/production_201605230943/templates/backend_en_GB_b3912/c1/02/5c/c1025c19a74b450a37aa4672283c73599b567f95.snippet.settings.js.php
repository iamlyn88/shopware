<?php /* Smarty version Smarty-3.1.12, created on 2016-07-11 12:44:19
         compiled from "/Users/Shared/development/projects_git/webshop/shopware-five/shopware/themes/Backend/ExtJs/backend/category/view/category/tabs/settings.js" */ ?>
<?php /*%%SmartyHeaderCode:374763311578378834caea1-23572413%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c1025c19a74b450a37aa4672283c73599b567f95' => 
    array (
      0 => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/themes/Backend/ExtJs/backend/category/view/category/tabs/settings.js',
      1 => 1463971432,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '374763311578378834caea1-23572413',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_578378836b1914_52226410',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_578378836b1914_52226410')) {function content_578378836b1914_52226410($_smarty_tpl) {?>/**
 * Shopware 5
...
',
        ...
        defaultSettingsTemplateLabel : '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'view'/'settings_default_settings_template_label','default'=>'Template selection','namespace'=>'backend/category/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'view'/'settings_default_settings_template_label','default'=>'Template selection','namespace'=>'backend/category/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Template selection<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'view'/'settings_default_settings_template_label','default'=>'Template selection','namespace'=>'backend/category/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        defaultSettingsTemplateHelp: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'view'/'settings_default_settings_template_help','default'=>'The template selection is only available for emotion templates. (SW 4)','namespace'=>'backend/category/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'view'/'settings_default_settings_template_help','default'=>'The template selection is only available for emotion templates. (SW 4)','namespace'=>'backend/category/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
The template selection is only available for Emotion templates (Shopware 4) and will be ignored for responsive themes.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'view'/'settings_default_settings_template_help','default'=>'The template selection is only available for emotion templates. (SW 4)','namespace'=>'backend/category/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
