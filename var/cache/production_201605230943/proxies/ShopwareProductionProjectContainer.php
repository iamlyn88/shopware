...
class ShopwareProductionProjectContainer extends Shopware\Components\DependencyInjection\Container
{
    ...
    {
        return $this->services['cache'] = $this->get('cache_factory')->factory('auto', array('automatic_serialization' => true, 'automatic_cleaning_factor' => 0, 'lifetime' => 3600, 'cache_id_prefix' => '68092884f8e4659250ca3422ea5aebb2'), array('hashed_directory_perm' => 511, 'cache_file_perm' => 438, 'hashed_directory_level' => 3, 'cache_dir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/general', 'file_name_prefix' => 'shopware'));
    }
    ...
    {
        return $this->services['db'] = $this->get('db_factory')->factory('pdo_mysql', array('username' => 'root', 'password' => 'root', 'dbname' => 'shopware5.1.6', 'host' => 'localhost', 'charset' => 'utf8', 'adapter' => 'pdo_mysql', 'port' => '3306'));
    }
    ...
    {
        return $this->services['hooks'] = new \Enlight_Hook_HookManager($this->get('events'), $this->get('loader'), array('proxyDir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/proxies', 'proxyNamespace' => 'Shopware_Proxies'));
    }
    ...
    {
        return $this->services['modelannotations'] = $this->get('model_annotations_factory')->factory($this->get('modelconfig'), '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/engine/Shopware/Models');
    }
    protected function getModelconfigService()
    {
        return $this->services['modelconfig'] = new \Shopware\Components\Model\Configuration(array('autoGenerateProxyClasses' => false, 'attributeDir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/doctrine/attributes', 'proxyDir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/doctrine/proxies', 'proxyNamespace' => 'Shopware\\Proxies', 'cacheProvider' => 'auto', 'cacheNamespace' => NULL), $this->get('cache'), $this->get('hooks'));
    }
    protected function getModelsService()
    {
        ...
        return $this->services['models'] = $this->get('model_factory')->factory($a, $this->get('modelconfig'), $this->get('loader'), $this->get('db_connection'), '/Users/Shared/development/projects_git/webshop/shopware-five/shopware', $this->get('modelannotations'));
    }
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/log/core_production.log', 14);
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/log/plugin_production.log', 14);
        $a->pushProcessor($this->get('monolog.processor.uid'));
    ...
    {
        return $this->services['shopware.snippet_database_handler'] = new \Shopware\Components\Snippet\DatabaseHandler($this->get('models'), $this->get('db'), '/Users/Shared/development/projects_git/webshop/shopware-five/shopware');
    }
    protected function getShopware_SnippetQueryHandlerService()
    {
        return $this->services['shopware.snippet_query_handler'] = new \Shopware\Components\Snippet\QueryHandler('/Users/Shared/development/projects_git/webshop/shopware-five/shopware/snippets/');
    }
    ...
    {
        return $this->services['shopware_media.media_service_factory'] = new \Shopware\Bundle\MediaBundle\MediaServiceFactory($this, array('backend' => 'local', 'strategy' => 'md5', 'adapters' => array('local' => array('type' => 'local', 'mediaUrl' => '', 'permissions' => array('file' => array('public' => 438, 'private' => 384), 'dir' => array('public' => 511, 'private' => 448)), 'path' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware'), 'ftp' => array('type' => 'ftp', 'mediaUrl' => '', 'host' => '', 'username' => '', 'password' => '', 'port' => 21, 'root' => '/', 'passive' => true, 'ssl' => false, 'timeout' => 30))));
    }
    ...
    {
        return $this->services['shopware_media.strategy_factory'] = new \Shopware\Bundle\MediaBundle\Strategy\StrategyFactory(array('backend' => 'local', 'strategy' => 'md5', 'adapters' => array('local' => array('type' => 'local', 'mediaUrl' => '', 'permissions' => array('file' => array('public' => 438, 'private' => 384), 'dir' => array('public' => 511, 'private' => 448)), 'path' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware'), 'ftp' => array('type' => 'ftp', 'mediaUrl' => '', 'host' => '', 'username' => '', 'password' => '', 'port' => 21, 'root' => '/', 'passive' => true, 'ssl' => false, 'timeout' => 30))));
    }
    ...
    {
        return $this->services['shopware_plugininstaller.plugin_download_service'] = new \Shopware\Bundle\PluginInstallerBundle\Service\DownloadService('/Users/Shared/development/projects_git/webshop/shopware-five/shopware', $this->get('shopware_plugininstaller.store_client'), $this->get('dbal_connection'));
    }
    ...
    {
        return $this->services['shopware_plugininstaller.plugin_manager'] = new \Shopware\Bundle\PluginInstallerBundle\Service\InstallerService($this->get('models'), $this->get('plugins'), '/Users/Shared/development/projects_git/webshop/shopware-five/shopware');
    }
    ...
    {
        return $this->services['theme_compiler'] = new \Shopware\Components\Theme\Compiler('/Users/Shared/development/projects_git/webshop/shopware-five/shopware', $this->get('oyejorge_compiler'), $this->get('theme_path_resolver'), $this->get('theme_inheritance'), $this->get('theme_service'), $this->get('js_compressor'), $this->get('events'));
    }
    ...
    {
        return $this->services['theme_path_resolver'] = new \Shopware\Components\Theme\PathResolver('/Users/Shared/development/projects_git/webshop/shopware-five/shopware', $this->get('template'));
    }
    ...
    {
        return $this->services['thumbnail_manager'] = new \Shopware\Components\Thumbnail\Manager($this->get('thumbnail_generator_basic'), '/Users/Shared/development/projects_git/webshop/shopware-five/shopware', $this->get('events'), $this->get('shopware_media.media_service'));
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware',
            'kernel.environment' => 'production',
            'kernel.debug' => false,
            'kernel.name' => 'Shopware',
            'kernel.cache_dir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943',
            'kernel.logs_dir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/log',
            ...
            'shopware.cdn' => array(
                ...
                'adapters' => array(
                    'local' => array(
                        ...
                        'path' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware',
                    ),
                    'ftp' => array(
                        'type' => 'ftp',
                        'mediaUrl' => '',
            ...
            'shopware.cdn.adapters.local.path' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware',
            ...
            'shopware.db.dbname' => 'shopware5.1.6',
            ...
            'shopware.template' => array(
                ...
                'charset' => 'utf-8',
                'forceCache' => false,
                'cacheDir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/templates',
                'compileDir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/templates',
            ),
            ...
            'shopware.template.cachedir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/templates',
            'shopware.template.compiledir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/templates',
            'shopware.mail' => array(
                'charset' => 'utf-8',
            ),
            ...
            'shopware.httpcache' => array(
                ...
                'cache_dir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/html',
                'cache_cookies' => array(
                    0 => 'shop',
                    1 => 'currency',
            ...
            'shopware.httpcache.cache_dir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/html',
            ...
            'shopware.cache' => array(
                'frontendOptions' => array(
                    ...
                    'lifetime' => 3600,
                    'cache_id_prefix' => '68092884f8e4659250ca3422ea5aebb2',
                ),
                'backend' => 'auto',
                'backendOptions' => array(
                    ...
                    'cache_dir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/general',
            ...
            'shopware.cache.frontendoptions.cache_id_prefix' => '68092884f8e4659250ca3422ea5aebb2',
            ...
            'shopware.cache.backendoptions.cache_dir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/general',
            'shopware.cache.backendoptions.file_name_prefix' => 'shopware',
            'shopware.hook' => array(
                'proxyDir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/proxies',
                'proxyNamespace' => 'Shopware_Proxies',
            ),
            'shopware.hook.proxydir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/proxies',
            'shopware.hook.proxynamespace' => 'Shopware_Proxies',
            'shopware.model' => array(
                'autoGenerateProxyClasses' => false,
                'attributeDir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/doctrine/attributes',
                'proxyDir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/doctrine/proxies',
                'proxyNamespace' => 'Shopware\\Proxies',
                'cacheProvider' => 'auto',
                'cacheNamespace' => NULL,
            ),
            'shopware.model.autogenerateproxyclasses' => false,
            'shopware.model.attributedir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/doctrine/attributes',
            'shopware.model.proxydir' => '/Users/Shared/development/projects_git/webshop/shopware-five/shopware/var/cache/production_201605230943/doctrine/proxies',
